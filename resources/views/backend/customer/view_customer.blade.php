                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Customer List
                                    <a class="btn btn-success float-right btn-sm" href="{{route('customers.add')}}">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        @foreach($allData as $key=>$customer)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <a  title="Edit" href="{{route('customers.edit',['id'=>$customer->id])}}" class="btn btn-sm btn-primary">
                                                                    ...
                                                                    <a  title="Delete" id="delete" href="{{route('customers.delete',['id'=>$customer->id])}}" class="btn btn-sm btn-danger">
