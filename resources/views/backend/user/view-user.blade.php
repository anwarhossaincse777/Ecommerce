                                                ...
                                                <div class="col-sm-12">
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>{{$user->email}}</td>
                                                            <td>
                                                                <a  title="Edit" href="{{route('user.edit',['id'=>$user->id])}}" class="btn btn-sm btn-primary">
                                                                ...
                                                                <a  title="Delete" id="delete" href="{{route('user.delete',['id'=>$user->id])}}" class="btn btn-sm btn-danger">
