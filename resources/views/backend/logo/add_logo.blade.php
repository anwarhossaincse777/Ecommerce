                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">DataTable for Add Logos</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">

                                        <form role="form" id="uploadForm" method="post" action="{{route('logos.store')}}" id="myForm" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <img id="show_logo" src="{{url('public/upload/logo/no_image.jpg')}}" style="width: 150px; height: 160px; border: 1px solid #000;" alt="">
                                                    </div>
                                                </div>
