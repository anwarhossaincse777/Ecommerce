                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form role="form" method="post" action="{{(@$editData)?route('brand.update',$editData->id):route('color.store')}}" id="myForm" enctype="">
                                            @csrf
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <div class="form-group">
                                                        <label>Color Name</label>
                                                        <input type="text" name="name" id="name" class="form-control input-sm"  value="{{@$editData->name}}" placeholder="Enter Color Name" required>
