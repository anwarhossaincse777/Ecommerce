                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">DataTable for Edit Sliders</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">

                                        <form role="form" id="uploadForm" method="post" action="{{route('slider.update',['id'=>$sliderData])}}" id="myForm" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <img id="show_logo" src="{{(!empty($sliderData->image))?url('upload/slider/'.$sliderData->image):url('public/upload/no_image.jpg')}}" style="width: 150px; height: 160px; border: 1px solid #000;" alt="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="short_title"  class="form-control input-sm" value="{{$sliderData->short_title}}" required>
