    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Mnanage Pending list</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Panding List
                                    <a class="btn btn-success float-right btn-sm" href="{{route('purchase.add')}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">DataTable with Purchase Pending</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                                ...
                                                <div class="col-sm-12">
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline table-responsive" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Purchase No</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Supplier Name</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Product Name</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Buying Price</th>
                                                        ...
                                                        @foreach($allData as $key=>$purchase)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td style="width: 12%">
                                                                    ...
                                                                    @if($purchase->status=='0')
                                                                        <a  title="approve" id="approveButton" href="{{route('purchase.approve',['id'=>$purchase->id])}}" class="btn btn-sm btn-success">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th rowspan="1" colspan="1">Suppllier Name</th>
