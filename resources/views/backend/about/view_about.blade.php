                                                ...
                                                <div class="col-sm-12">
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">About description</th>
                                                        ...
                                                        @foreach($allData as $key=>$about)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <a  title="Edit" href="{{route('abouts.edit',['id'=>$about->id])}}" class="btn btn-sm btn-primary">
                                                                    ...
                                                                    <a  title="Delete" id="delete" href="{{route('abouts.delete',['id'=>$about->id])}}" class="btn btn-sm btn-danger">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th rowspan="1" colspan="1">About description</th>
