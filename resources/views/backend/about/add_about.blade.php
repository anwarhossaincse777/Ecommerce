                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form role="form" method="post" action="{{route('abouts.store')}}" id="myForm" enctype="">
                                            @csrf
                                            <div class="row">
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <label>About Description</label>
                                                        <textarea  name="description" id="description" class="form-control input-sm" placeholder="Description"  id="" cols="30" rows="10"></textarea>
