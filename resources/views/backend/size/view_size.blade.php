                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Brand List
                                    <a class="btn btn-success float-right btn-sm" href="{{route('size.add')}}">
                                                ...
                                                <div class="col-sm-12">
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Size Name</th>
                                                        ...
                                                        @foreach($allData as $key=>$size)
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <a  title="Edit" href="{{route('size.edit',['id'=>$size->id])}}" class="btn btn-sm btn-primary">
                                                               ...
                                                               @if($count_size<1)
                                                                    ...
                                                                    <a  title="Delete" id="delete" href="{{route('size.delete',['id'=>$size->id])}}" data-token="{{csrf_token()}}" data-id="{{$size->id}}" class="btn btn-sm btn-danger">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th rowspan="1" colspan="1">Size Name</th>
