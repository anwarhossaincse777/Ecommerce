                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Add Units
                                    <a class="btn btn-success float-right btn-sm" href="{{route('units.view')}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form role="form" method="post" action="{{route('units.update',['id'=>$editData->id])}}" id="myForm" enctype="">
                                            @csrf
                                            <div class="row">
