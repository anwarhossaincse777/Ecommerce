                                                ...
                                                <div class="col-sm-12">
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Unit Name</th>
                                                        ...
                                                        @foreach($allData as $key=>$unit)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                @php
                                                                    $count_units=\App\Product::where('unit_id',$unit->id)->count() ;  //j unit table er unit id ta koto bar product_id te use hoise ta count er maddome ber korlam

                                                                @endphp
                                                                <td>
                                                                    <a  title="Edit" href="{{route('units.edit',['id'=>$unit->id])}}" class="btn btn-sm btn-primary">
                                                                    ...
                                                                    <a  title="Delete" id="delete" href="{{route('units.delete',['id'=>$unit->id])}}" class="btn btn-sm btn-danger">
