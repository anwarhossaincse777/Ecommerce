                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Brand List
                                    <a class="btn btn-success float-right btn-sm" href="{{route('brand.add')}}">
                                                ...
                                                <div class="col-sm-12">
                                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        @foreach($allData as $key=>$brand)
                                                            ...
                                                            @endphp
                                                            <tr class="{{$brand->id}}" role="row" class="odd" >
                                                                ...
                                                                <td>
                                                                    <a  title="Edit" href="{{route('brand.edit',['id'=>$brand->id])}}" class="btn btn-sm btn-primary">
                                                                ...
                                                                @if($count_brand<1)
                                                                    <a  title="Delete" id="delete" href="{{route('brand.delete')}}" data-token="{{csrf_token()}}" data-id="{{$brand->id}}" class="btn btn-sm btn-danger">
